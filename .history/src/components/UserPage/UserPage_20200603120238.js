...
const UserPage = (props) => (
  ...
  <div className="welcome">
    ...
    <h2>You've came to the right place</h2>
        ...
        <p>If nothing on the Blog Post page catches your eye go ahead and try our Get a Sauce tab. This tab will provide you with a random sauce recipe, so we suggest you use it before you </p>
      </div>
  </div>
  </>
);
