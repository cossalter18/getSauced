...
class Edit extends Component {
    ...
    state = {
        post: {
            id: this.props.reduxState.getDetailsReducer.id,
            title: '',
            body: ''
        }
            ...
            <>
                ...
                <div className='title'>
                    <TextField className="title"
                        ...
                        name="title"
                        placeholder="Title"
                        defaultValue={this.props.reduxState.getDetailsReducer.title}
                ...
                <div>
                    <textarea
                        ...
                        defaultValue={this.props.reduxState.getDetailsReducer.body}
                        rows={5}
                        rowsmax={5}
                        cols={100}
